...
from chat_src.utils.models import SqlResponse, NaturalResponse
...
class Text2Sql:
    ...
    def load_yaml_config(command_fname: str) -> dict:
        ...
        config_path = os.path.join(PROJECT_ROOT, "chat_src", "configs", command_fname)
    ...
    def generate_prompt(self, user_query: str, schema_info: str) -> str:
        ...
        prompt_template = self.load_yaml_config(
            f"tsql_prompt_{self.shot}shot.yaml"
        ).get("tsql_prompt")
